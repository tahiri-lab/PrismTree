...
def primconstree(inputs: list[ete3.Tree], format: int = 0, outputfile: str = None, modified_prim: bool = True, 
                avg_on_merge: bool = False, debug: bool = False) -> ete3.Tree:
    """ Generate the primconstree tree
        arguments:
            - inputfile (list[ete3.Tree]): list of ete3 trees
    ...
    """
    #logging.info("Generating PrimConsTree")
    ...
    if outputfile:
        ...
        tree.write(outfile=filename_unique, format=format)
